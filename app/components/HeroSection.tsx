          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 animate-fade-in-up text-center">
              ...
              <div className="md:hidden flex justify-center w-full">
                <button
                  className="group bg-gradient-to-r from-[#022d58] to-[#003c96] text-white px-8 py-4 rounded-full font-semibold text-lg shadow-2xl hover:shadow-3xl transform hover:-translate-y-1 transition-all duration-300 flex items-center space-x-2"
                  onClick={() => {
