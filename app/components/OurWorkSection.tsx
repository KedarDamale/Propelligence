              ...
              >
                <div className="flex flex-col items-center pt-1 pb-1 px-1 w-full">
                  ...
                  <div className="flex justify-center w-full">
                    ...
                    >
                      {!isExpanded ? (
                        <span className="block text-center w-full break-words text-gray-700" style={{ whiteSpace: 'pre-wrap' }}>{shortDesc || 'No description available.'}</span>
                      ) : (
                        <>
                          ...
                          <div className="flex justify-center w-full">
                            {blog.description && blog.description.length > 0
                              ? blog.description.split(/\r?\n/).map((line, idx) => (
                                  <span key={idx} className="block text-center w-full break-words" style={{ whiteSpace: 'pre-wrap' }}>{line || '\u00A0'}</span>
                                ))
